...
var ungrunge = JSON.parse(grungeAlbumsJSON)
...
// var test = grungeAlbums.albums[0]
// console.log("Album: " + test.name)
// console.log("Artist: " + test.artist)
// console.log("Units Sold " + test.unitsSold)
...
var unJ = JSON.stringify(validJSON)
var reJ = JSON.parse(unJ)
var superJ = JSON.stringify(reJ)
console.log(unJ)
console.log(reJ)
console.log(superJ)

...
var albums = JSON.stringify(grungeAlbums);
var grungeAlbumsJSON = JSON.parse(albums);
...
for (var i = 0; i < grungeAlbums.albums.length; i++) {
    console.log("Album: " + grungeAlbums.albums[i].name + " Artist: " + grungeAlbums.albums[i].artist + " Units sold: " + grungeAlbums.albums[i].unitsSold);
};

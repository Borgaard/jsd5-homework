...
for ( var totalNum = 100; totalNum > 0 ; totalNum-- ){
    if ( (totalNum % 3) === 0 ){
        console.log("fizz");
    }
    if ( (totalNum % 5) === 0 ){
...
for ( var totalNum = 100; totalNum > 0 ; totalNum-- ){
    var myOutcome = " ";
    if (totalNum % 3 === 0){ 
        console.log(myOutcome += "Fizz");
    }
    if (totalNum % 5 === 0){
        console.log(myOutcome += "Buzz");
    }
    else {
        console.log(totalNum);
    }
...
/*
for (var totalNum = 100; totalNum > 0 ; totalNum-- ) { 
    console.log((totalNum % 3 ? '':'Fizz')+(totalNum % 5 ?'':'Buzz') || totalNum );
}
*/
...
/*
for ( var totalNum = 100; totalNum > 0 ; totalNum-- ) {
  var myThree = totalNum % 3 == 0, 
        myFive = totalNum % 5 == 0;
  console.log(myThree ? myFive ? "FizzBuzz" : "Fizz" : myFive ? "Buzz" : totalNum);
}
*/
// **************************************************************************************************************************************
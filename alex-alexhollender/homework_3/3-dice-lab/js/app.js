...
var diceOne = document.getElementById("first-die");
var diceTwo = document.getElementById("second-die");
var button = document.getElementById("roll-dice");


button.onclick = function() {
  diceOne.className = "dice-" + random1;
  diceTwo.className = "dice-" + random2;

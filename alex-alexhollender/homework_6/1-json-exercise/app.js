...
var grungeAlbumsBackAgain = JSON.parse(grungeAlbumsJSON);

for (var i = 0; i < grungeAlbumsBackAgain.albums.length; i++) {
    for (var prop in grungeAlbumsBackAgain.albums[i]) {
    console.log(prop.charAt(0).toUpperCase() + prop.slice(1) + " = " + grungeAlbumsBackAgain.albums[i][prop]);
    };
    console.log("\n")
};
...
var myJsObject = JSON.stringify(myJsonObject);

var myJsObjectBackAgain = JSON.parse(myJsObject);

console.log(myJsonObject);
console.log(myJsObject);
console.log(myJsObjectBackAgain);

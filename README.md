...
**Submit homework by pushing to your jsd5-homework repo, then submit a pull request**
 ...
 4 | [Hubot lab](https://github.com/svodnik/sfjs5/tree/master/05-slackbot-lab) + [Convert between JSON and JavaScript objects](https://github.com/svodnik/sfjs5/tree/master/06-objects-json) _- contains reading for next week_ | Hubot in-class lab | Tuesday, November 22nd
 5 | - | - | -
